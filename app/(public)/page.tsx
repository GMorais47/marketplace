  ...
  return (
    <Card>
      ...
      <div className="flex justify-end mt-1.5">
        <button onClick={onClick} title="Adicionar" className="hover:bg-[#00BC99] h-8 w-8 bg-[#03738C] text-white flex items-center justify-center rounded-md p-2 cursor-pointer">
          <FaCartPlus size={16} />
        </button>
      </div>
    </Card>
